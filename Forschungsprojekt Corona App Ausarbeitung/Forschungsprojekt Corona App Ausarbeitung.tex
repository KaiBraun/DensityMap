...
\subsubsection{Bewertung}
Das Feature der Density-Map erziehlt im Hinblick auf die Eindämmung des Coronaviruses keinen besonders hohen Nutzen im Vergleich zu anderen vorgestellten Erweiterungen.
...
Deshalb träge die Density-Map vor Allem in Zeiten der Lockerung der Beschränkungsmaßnahmen einen guten Teil dazu bei, den Zustand zu erhalten.
...
Die Density-Map sammelt in allen vorgestellten Lösungsansätzen keine Sensiblen Nutzerdaten und verfolgt einen weitesgehend dezentralen Ansatz. 
...
Trotzdem ist gerade im infrastrukturlosen Ansatz ohne zentrale Masten möglich, Ansammlung von Menschen im Privaten Raum (wie etwa Parties) zu tracken. 
...
Dagegen hilft eine klare Aufklärung darüber, wie das Feature im konkreten funktioniert, sowie eine freiwillige Teinahme am Benutzen der Density-Map. 
...
Dies stellt jedoch weder ein Risiko für alle anderen Masten dar, noch für einen Nutzer, der sich in Nähe eines gehackten Masten befindet, da wie bereits nur anonyme und verschlüsselte Daten mit dem Masten ausgetauscht werden. 

Für die Umsetzung des Density-Map features stellt sich ein größerere Aufwand zur Installation der zentralen Masten auf. Um eine gute deutschlandweite Abdeckung zuerreichen müssten hierfür vermutlich zehn- bis hunderttausende von Geräten zu Verfügung gestellt werden, die als zantraler Mast fungieren könnten.
Beim infrastrukturlosen Ansatz würde dieser Punkt jedoch wegfallen.

Alles in Allem stellt das Density-Map Feature eine gute Erweiterung der Corona Warn App, sowohl im Hiblick auf die Eindämmung des Viruses, als auch für eine unabhängige Nutzung außerhalb der Pandemie, dar.
