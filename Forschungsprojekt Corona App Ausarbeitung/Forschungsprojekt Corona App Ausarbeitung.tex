...
Eine Übersicht, inwiefern der gemessene Wert mithilfe der Korrekturformel korrigiert wird, wird in Abb. \ref{cor_factor} aufgezeichnet. 
...
\subsection{Simulation der RPI-basierten Formel}
...
Erst daraufhin wurde die ID-basierte Korrekturformel erstellt. 
...
\textit{Simulation der ID-basierten Korrekturformel:}
