...
Im Falle der zweiten Möglichkeit, einer bereits existierenden Servergruppe beizutreten, benötigt man Kontaknt zu einem Mitglied der Servergruppe.
...
Der mit einem TEK verbundene Risikowert wird dazu genutzt, um die Wahrscheinlichkeit zu ermitteln, ob der Teilende des TEKs mit Corona infiziert ist.
...
In diesem Feature wird das volle Potenzial des TRLs, welches in Abschnitt \ref{TRL} genauer beschrieben wurde, genutzt. 
