...
Laut derzeitigem Stand sind es etwa 173 Millionen Infizierte und 3,7 Millionen Todesopfer \cite{CoronaZahlenWorld}, wobei die Dunkelziffer weitaus höhere Werte vermuten lässt. 
...
So war man beispielsweise verpflichtet in Restaurants oder Bars seine Kontaktdaten zu hinterlegen, damit man, im Falle einer potenziellen Begegnung mit einem Infizierten in der Einrichtung, benachrichtigt werden kann.
...
Aus diesem Grund wurde von der Bundesrepublik Deutschland die Entwicklung einer App in Auftrag gegeben, die diese Kontaktverfolgung automatisieren sollte: Die \textit{Corona Warn App} (CWA) \cite{}. Ein zentraler Bestandspunkt der App ist die Privatsphäre, die mittels dezentraler Kontaktverfolgung und anonymen Datenaustausches garantiert ist.
...
bevor es in Abschnitt \ref{Erweiterte_Risikoberechnung} und \ref{Density_Map} mit der \textit{erweiterten Risikoberechnung} und der \textit{Density-Map} weiter geht. 
...
Des weiteren wird auf bestehende Arbeiten in Richtung Crowd-Sensing, insbesondere mittels des BLE Features, eingegangen. 
...
\subsection{Transmission Risk Level (TRL):}
\label{TRL}
...
weshalb in Abschnitt \ref{Feature TRL Update} das Feature TRL Update vorgestellt wird, dass eine Lösung zeigt die fehlenden Daten zu sammeln.
...
\bibitem{DP-3T} C. Troncoso et al., "Decentralized Privacy-Preserving Proximity Tracing" \\https://github.com/DP-3T/documents/blob/master/DP3T\%20White\%20Paper.pdf (10.06.2021)
