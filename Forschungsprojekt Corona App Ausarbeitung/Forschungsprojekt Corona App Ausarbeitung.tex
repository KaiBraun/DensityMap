...
Ebenso werden die NOT-CWA-User in drei Untergruppen aufgeteilt: \textit{Not-CWA-Positive} sind alle Personen, die ein positives Test Ergebnis haben, 
...
Dabei werden anstatt der ursprünglichen zwei Farben nun vier Farben verwendet: Rot, Orange, Gelb und Grün.
\\
...
\subsubsection{R\textsubscript{CWA-Positive}}
\label{CWAPositive}
...
Wobei der \textit{attFactor} durch folgende Intervalle aus der Distanz att bestimmt wird:
